...
**Geprüft bisher:** B01 — zwei Durchläufe, Reparatur bestätigt (17 von 20 Kriterien).
...
| BF-06 | B01 | Bestätigungstoken im Log — `doctrine`-Channel in `prod` ausgeschlossen | mittel | 2026-08-23 | **noch nicht** |
