...
| 02 | Barrierefreiheit der Plattform (EN 301 549 / RAWeb) | P0 | **deployed** | B01–B26 | 2026-09-15 · **Rückmeldeweg der Barrierefreiheitserklärung nennt `support@endlech.lu`** (vorher `info@`, existiert nicht), live in `v2026.09.15.1`. ⚠ Barriere-Meldungen gehen an `CONTACT_EMAIL` — Wert in Coolify, von außen nicht prüfbar. — 2026-08-29 · live in v2026.08.29 |
...
| 10 | Sitemap und robots.txt (Auffindbarkeit in Suchmaschinen) | P1 | **deployed** | B05, B06, B13, B24, 03, 05, 06, 07 | 2026-09-13 · **Deployed mit `v2026.09.13`** (#125, #126), auf der Produktion nachgeprüft: Sitemap 96 Einträge und Schema gültig, canonical/Sprachverweise/noindex wie spezifiziert, BF-147 ohne Abweichung, Deckel bei Nr. 61 (`qa/10/produktion-2026-09-13.md`). **Offen beim Betreiber:** T17/T18 in der Search Console (AK-24/25), OF-05 bis OF-08. — 2026-09-13 · **QA-Nachprüfung: BF-147 behoben und nachgeprüft** (384 Abrufe ohne Abweichung, Regression 26/26, 1195 Tests), Production-ready ja. Offen: BF-148/OF-08, OF-05–07, AK-24/25 nach dem Deploy. Vor `/sdd-deploy 10` den Fix-Branch committen und nach `main` mergen. — 2026-09-13 · BF-147 behoben auf `fix/bf-147-seitenzahl` (Status auf Entscheidung des Betreibers von `approved` zurückgenommen), 1194 Tests grün; BF-148 und die Board-Frage als OF-08/OF-07 an den Betreiber. Nächster Schritt `/sdd-qa 10`. — 2026-09-13 · **QA: 23/25 bestanden, 2 nicht prüfbar (Search Console nach dem Deploy), Production-ready ja.** Befunde BF-147 (mittel, Seitenzahl-Regel auf jeder Seite) und BF-148 (niedrig, EC-05), beide nicht blockierend — empfohlen: vor dem Deploy beheben. Geprüft im Produktionsmodus, Prüfwerkzeug `qa/10/`. — 2026-09-12 · Bau abgeschlossen auf `feature/10-sitemap-robots`, nicht committet: 16 von 18 Aufgaben (T17/T18 nach dem Deploy), 1187 Tests grün, Abschlussbericht am Ende von `tasks.md`. Offen: OF-05, OF-06. Nächster Schritt `/sdd-qa 10`. Aufgabenplan: 18 Aufgaben in fünf Ebenen plus zwei Plattformaufgaben nach dem Deploy, alle 25 Kriterien zugeordnet. Systemdesign mit 25 von 25 Kriterien abgedeckt; OF-01 und OF-04 beim Entwurf entschieden (AK-13, AK-15, AK-16 nachgefasst). Offen und nicht blockierend: OF-02 sprechende Adressen, OF-03 `www` ohne Weiterleitung. Spec mit 25 Kriterien abgenommen. Anlass: Google Search Console für `endlech.lu` eingerichtet, aber `/robots.txt` liefert 404 und eine Sitemap gibt es nicht. Vorstufe zum Growth-Loop |
| 11 | Nutzung messen, ohne zu verfolgen (Umami) | P2 | **deployed** | 07, 10 | 2026-09-14 · **live in `v2026.09.14.2`, auf der Produktion nachgeprüft** — Weiterleitung an Umami 200 mit Sitzungs-Token (dritter Anlauf: Variable im Container leer, dann erster Aufruf nach Umami-Start über dem Zeitlimit), Messregel, `/legal` vier Sprachen, Changelog, Deckel 429. OF-01, OF-05, OF-06, OF-08 vom Betreiber entschieden (Decision Log #29–#32). Abnahme T44 vom Betreiber bestätigt. Offen beim Betreiber: T33, T34, T43. — 2026-09-14 · **QA-Nachprüfung 3 (Überarbeitung Umami-Domain): Production-ready ja, kein Befund** — gegen Umami 3.3.1 ohne Einstellungen hinter Traefik: LU und FR in zwei Sitzungen trotz untergeschobener Adresse, Zertifikatsprüfung weist falschen Namen und selbst signiert ab, `mcp-umami` ohne Adresse, 1336 Tests grün, Code-Review ohne Fund. Nicht prüfbar bis zu den Betriebsschritten: AK-26 am echten VPS, AK-28, AK-41, AK-35, AK-32, AK-34. Nächster Schritt T32–T34, dann `/sdd-deploy 11`. — 2026-09-14 · **Überarbeitung gebaut (T35–T41)** auf `feature/11-umami-domain`, nicht committet: Feld `ip` im Zählaufruf, Zertifikatsprüfung statt Schlüsselbindung, `APP_UMAMI_UPSTREAM_PIN` entfernt, `/legal` mit Region/Stadt und monatlich, `mcp-umami` ohne Adresse in Ausgaben. 1336 Tests grün; Selbsttest gegen Umami 3.3.1: LU und FR in zwei Sitzungen. Offen beim Betreiber T32–T34, T42–T44. Nächster Schritt `/sdd-qa 11`. — 2026-09-14 · **Aufgabenplan der Überarbeitung:** T32–T44 — Betrieb T32–T34 (Route, Konten mit 2FA, Zugangsdatei), Ebene 2 T35/T36 (Kürzung, Weiterleitung mit `ip` und Zertifikatsprüfung, PIN entfällt), Ebene 3 T37, Ebene 5 T38–T40 (Text Stadt/monatlich, Datenschutz, CLAUDE.md), extern T41 (`mcp-umami` ohne Domain), Plattform T42–T44. Alle 42 Kriterien abgedeckt; T01–T05, T29–T31 überholt. Nächster Schritt `/sdd-build 11`. — 2026-09-14 · **Entwurf überarbeitet:** Weiterleitung an die Umami-Domain mit gewöhnlicher Zertifikatsprüfung (Schlüsselbindung und `APP_UMAMI_UPSTREAM_PIN` entfallen); Besucheradresse als Feld `ip` im Zählaufruf (an Wegwerf-Instanz 3.3.1 nachgestellt: ohne `ip` alle Besucher in einer Sitzung und im falschen Land); Umami-Vorgaben für Ort (Stadt) und Sitzung (monatlich); `mcp-umami` im globalen Skill ohne Domain in Ausgaben; fünf neue Betriebsschritte. Alle 42 Kriterien abgedeckt. Nächster Schritt `/sdd-tasks 11`. — 2026-09-14 · **Spec überarbeitet: vorhandenes Umami über seine eigene Domain** statt eigenem Zähl-Eingang, Firewall, Länderdatei und Tunnel; der zweite VPS wird darüber hinaus nicht verändert. Weiterleitung über endlech.lu bleibt; Ort jetzt Land, Region und Stadt (offen in `/legal`); Growth-Loop mit Lese-Benutzer über die Domain; Betreiberkonto mit 2FA; Direktaufrufe an die Domain hingenommen. Geändert AK-04/24/26/27/31/39, entfallen AK-38, neu AK-40–42, EC-08, OF-08. ⚠ `v2026.09.14.1` (alte Fassung, Messung aus) liegt auf `master` und wird **nicht** ausgerollt. Nächster Schritt `/sdd-architektur 11`. — 2026-09-14 · **QA-Nachprüfung 2: BF-152 bestätigt behoben, Production-ready ja** — gesperrte Sperrdatei ergibt 202, kein hängender Platz, der eine Platz hält; 1330 Tests grün, kein Review-Fund. Kriterien unverändert (28 · AK-15 teilweise bis B15 ausgeliefert · 10 nicht prüfbar). Nächster Schritt `/sdd-deploy B15`, dann `/sdd-deploy 11`. — 2026-09-13 · Auf Entscheidung des Betreibers von `approved` über `review` zurückgenommen; **BF-152 behoben** (nicht committet): defekte Sperre ergibt 202 statt 500, am laufenden Server nachgeprüft, 1330 Tests grün. Nächster Schritt `/sdd-qa 11`. — 2026-09-13 · **QA-Nachprüfung: BF-149 und BF-150 bestätigt behoben, Production-ready ja** — 28 bestanden, AK-15 teilweise (Zielgruppenseiten blockiert durch BF-151 in B15), 10 nicht prüfbar (zweiter VPS). Neu BF-152 (mittel, 500 bei defekter Sperre). Bedingungen: `APP_UMAMI_*` erst nach T01–T05, Instanz-Kriterien beim Scharfschalten belegen. Empfohlen zuerst `/sdd-build B15 BF-151 beheben`. — 2026-09-13 · **BF-149 und BF-150 behoben**, nicht committet: ein Platz für die Weiterleitung (hängender Eingang hält nur noch einen Aufruf, Seite 1,8 s → 0,06 s), Trichterschritte mit führendem Stern (gegen frische Umami-3.3.1-Instanz nachgeprüft). 1324 Tests grün. Neu OF-07 (Trichtertabelle in `design.md`). Nächster Schritt `/sdd-qa 11`. — 2026-09-13 · **QA: 27 bestanden, 2 durchgefallen, 10 nicht prüfbar (zweiter VPS, T01–T05), Production-ready nein.** BF-150 (hoch): Trichter mit `*` mitten im Pfad zählen in Umami 3.3.1 null — AK-14/AK-15. BF-149 (mittel): hängender Zähl-Eingang hält gleichzeitige Anfragen bis 3,7 s, Seite wartete 2 s. Zählweg sonst angriffsfest (34/34 Browser, 32/32 Angriffe, AK-37 unter fünf Bedingungen). Geprüft gegen lokalen Umami-3.3.1-Nachbau (`qa/11/umgebung.md`). Nächster Schritt `/sdd-build 11 BF-149 und BF-150 beheben`. — 2026-09-13 · aufgenommen: Betreiber entscheidet Umami, **selbst gehostet auf dem zweiten VPS** (neben Uptime Kuma). Löst BE-02 und den Roadmap-Eintrag `usage_analytics` ein; die öffentliche Zusage „ohne Cookies und ohne Personendaten" ist die Bedingung. ⚠ Widerspricht dem PRD (schließt Web-Analytics aus) — PRD zieht mit. Liefert die Events für Loop 2 des Growth-Loops. — 2026-09-13 · **Spec geschrieben** (`features/11-nutzungsmessung/spec.md`): 39 AK, 7 EC; OF-01 bis OF-04 am selben Tag entschieden (vorsichtige Formulierung in `/legal`, VPS in Deutschland, Loop baut Tunnel selbst, Ausfall als AK-37). ⚠ Vor dem Deploy: `/sdd-betrieb` prüft die Roadmap-Zusage und die unbegrenzte Aufbewahrung. Messung über endlech.lu geleitet (Kuma-VPS bleibt verborgen), Oberfläche nur per SSH-Tunnel. — 2026-09-13 · **Entwurf** (`design.md`): Zählskript als Datei, Weiterleitung `POST /api/send` mit Prüfung nach Ereigniskatalog, TLS mit Schlüsselbindung zum zweiten VPS, Länderdatenbank, Sitzungskennung täglich, Tunnel im MCP-Server. Abdeckung 39/39, neun AK an Betriebsschritten. — 2026-09-13 · **Aufgabenplan** (`tasks.md`): 31 Aufgaben — T01–T05 Betrieb auf dem zweiten VPS (vor der QA), fünf Ebenen T06–T27, T28 im Skill `growth-loop`, T29–T31 rund um den Deploy. Abdeckung 39/39 in beide Richtungen maschinell geprüft. — 2026-09-13 · **Bau abgeschlossen** auf `feature/11-nutzungsmessung`, nicht committet: T06–T28 erledigt, 1317 Tests grün, Selbsttest im Produktionsmodus; offen T01–T05 (zweiter VPS, Betreiber) und T29–T31. Neue offene Fragen OF-05 (Dubletten zählen als Eintragung), OF-06 (Rechtsgrundlage in `/legal`). Nächster Schritt: Betriebsschritte T01–T05, dann `/sdd-qa 11` |
...
| B13 | Statische Inhaltsseiten | P2 | **deployed** | — | 2026-09-15 · **Kontaktadresse im Impressum `support@endlech.lu`** statt der nicht existierenden `info@endlech.lu`, live in `v2026.09.15.1` (#137), fünf Sprachen nachgeprüft (`qa/v2026.09.15.1/`). — 2026-09-11 · war live, auditiert; Reparaturen in v2026.08.29 |
...
| B15 | Organisations-Wartelisten | P0 | **deployed** | B14 | 2026-09-14 · **live in `v2026.09.14`, BF-151 auf der Produktion nachgeprüft** — alle 16 Seiten mit Formularziel, Absenden von den Zielgruppenseiten 422 statt 405 (mit und ohne JavaScript, ohne echten Eintrag). Offen: BF-153 (niedrig), OF-BF151a. — 2026-09-14 · **QA-Nachprüfung BF-151: behoben, Production-ready ja** — 23 von 23 im echten Browser (vier Seiten × vier Sprachen, ohne JavaScript, Typwechsel, 422, Honeypot, Deckel), Angriff unverändert abgewiesen, 1199 Tests grün. Neu BF-153 (niedrig, zwei ungenaue Texte). ⚠ Auf der Produktion noch aktiv. Nächster Schritt `/sdd-deploy B15`. — 2026-09-13 · **BF-151 (hoch, auf der Produktion aktiv):** Eintragen von den drei Zielgruppenseiten endet in einer 405-Fehlerseite, Formular ohne `action`. Gefunden in QA Feature 11, Nachtrag im QA-Bericht von B15; **Behoben auf `fix/bf-151-zielgruppen-formular`** (nicht committet): Formular trägt `action`, 1199 Tests grün, Gegenprobe rot; neu OF-BF151a. Nächster Schritt `/sdd-qa B15`. — 2026-09-12 · live in `v2026.09.12.1`; BF-119 auf Produktion nachgeprüft (**422 statt 500**), dazu BF-129 und BF-130 |
